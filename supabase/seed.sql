...
(
  ...
  'A foldszinti lepcsohaz javitasanal nincs egyertelmu tervreszlet a szegelykiosztashoz, ez lassitja a munkat.',
  'Burkolas',
  'Lepcsohaz',
  'waiting_external',
  'high',
...
(
  ...
  'Metadata-only seed rekord epitesz tervhez. Valodi Storage feltoltes meg nincs.',
  'Burkolas',
  'Foldszint',
...
(
  ...
  'Metadata-only seed rekord muszaki tervreszlethez, amely akadaly vagy hiba mellett hivatkozhato lesz.',
  'Burkolas',
  'Lepcsohaz',
...
(
  ...
  'Metadata-only seed rekord projekt szintu fotodokumentumhoz, issue evidence-tol elkulonitve.',
  'Burkolas',
  'Furdoszoba',
