...
-- project_documents seed rekordok szandekosan nincsenek: metadata-only bejegyzes
-- valodi feltoltott fajl nelkul felreverzeto (nincs mit megnyitni). Uj dokumentum
-- csak a /documents oldal feltoltesevel johet letre, valodi fajllal egyutt.
