-- Kivitely MVP database schema draft
-- Supabase / PostgreSQL kompatibilis első vázlat.
-- Supabase még nincs bekötve; később RLS policy-k és tenant kezelés kerül rá.
